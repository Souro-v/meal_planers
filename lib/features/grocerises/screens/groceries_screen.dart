                ...
                return ListView(
                  ...
                  children: [
                    ...
                    if (c.showAllergenWarning.value) ...[
                      _AllergenWarning(
                          onDismiss: c.dismissAllergenWarning),
                      const SizedBox(height: 16),
                    ],
      ...
      children: [
        ...
        if (showDivider)
          const Divider(height: 1, indent: 16,
              endIndent: 16, color: AppColors.divider),
      ],
    );
  }
}