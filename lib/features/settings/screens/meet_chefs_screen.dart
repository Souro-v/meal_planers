...
class MeetChefsScreen extends StatelessWidget {
  ...
  static const _chefs = [
    ChefModel(
      ...
      bio: 'Marcus has spent 15 years perfecting the art of Mediterranean cooking, focusing on fresh ingredients and bold flavors.',
      emoji: '👨‍🍳',
      recipeCount: 48,
    ),
    ChefModel(
      ...
      bio: 'Born in Tokyo, Yuki blends traditional Japanese techniques with modern flavors to create unique and delicious dishes.',
      emoji: '👩‍🍳',
      recipeCount: 36,
    ),
    ChefModel(
      ...
      bio: 'Sofia grew up in a small Italian village where cooking was a family tradition. Her pasta dishes are legendary.',
      emoji: '🧑‍🍳',
      recipeCount: 52,
    ),
    ChefModel(
      ...
      bio: 'Amara is passionate about showing that vegan food can be just as rich, satisfying, and delicious as any other cuisine.',
      emoji: '👩‍🍳',
      recipeCount: 29,
    ),
    ChefModel(
      ...
      bio: 'As a busy father of three, Daniel specializes in delicious meals that take 30 minutes or less to prepare.',
      emoji: '👨‍🍳',
      recipeCount: 61,
    ),
  ];
